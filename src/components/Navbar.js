...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-white p-4 shadow-lg border-b border-gray-700 fixed top-0 left-0 w-full z-50">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-center items-center px-6 md:px-8">
        
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-2xl absolute left-4 top-4 focus:outline-none transition-transform duration-200"
        ...
        >
          {[
            ...
            <Link
              ...
              smooth
              to={item.to}
              className="block md:inline-block px-4 py-3 text-lg font-medium text-gray-300 
          ...
          <Link
            smooth
            to="#contact"
            className="block md:inline-block px-6 py-2 mt-3 md:mt-0 bg-white text-black font-semibold rounded-md 
